            ...
            >
                <div className="flex items-center gap-5">
                    ...
                    <div className="flex items-baseline gap-1">
                        <span className="text-[10px] sm:text-sm text-gray-500 tracking-wide ">
                            {selected.base}
                        </span>
                        <span className="text-[10px] sm:text-sm text-gray-500">/{selected.quote}</span>
                    </div>
                </div>
                    ...
                    <div className="px-2 pt-2 pb-1">
                        <div className="flex items-center gap-2 px-2 py-1.5 rounded  border border-gray-300">
                            ...
                            <input
                                ...
                                className="flex-1 bg-transparent text-xs md:text-sm text-gray-600 placeholder-gray-600 outline-none"
                            />
                            {search && (
                                ...
                                return (
                                    <li key={pair.symbol}>
                                        <button
                                            ...
                                            className={`w-full flex items-center justify-between px-3 py-2 text-left transition-colors duration-100
                        ${isSelected
                                                    ? ' text-gray-600 '
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                ...
                                                <div>
                                                    <span className="text-xs font-medium">{pair.base}</span>
                                                    <span className="text-xs text-gray-600">/{pair.quote}</span>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <span className="text-[10px] text-gray-600">{pair.name}</span>
                                                {isSelected && (
